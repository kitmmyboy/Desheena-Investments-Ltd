...
-- Requirements: 1.1, 1.7, 16.3, 16.7
-- ============================================================

-- ============================================================
-- 1. Ensure audit_log has all required columns
--    The existing ip_address column is INET (superset of TEXT).
--    All other required columns already exist from the initial schema.
-- ============================================================
...
BEGIN
  ...
  -- Validate role value; fall back to 'Customer' if unrecognised
...
-- ============================================================
-- Revoke public EXECUTE on trigger functions (security hardening)
-- These are internal trigger functions, not public API endpoints.
-- ============================================================
